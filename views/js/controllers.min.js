...
status.quality.label=nb,nb.toString().length>2&&(status.quality.wide=!0),done(status,summary,results)})}}};return bandwidthTester}),define("taoClientDiagnostic/tools/upload/tester",["jquery","lodash","i18n","async","util/url","taoClientDiagnostic/tools/diagnostic/status"],function($,_,__,async,urlHelper,statusFactory){"use strict";var _kilo=1024,_mega=_kilo*_kilo,data=[],generateStr=function(length){for(var text="",possible="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",i=0;i<length;i++)text+=possible.charAt(Math.floor(Math.random()*possible.length));return text},upload=function(size){var url=urlHelper.route("upload","CompatibilityChecker","taoClientDiagnostic",{
