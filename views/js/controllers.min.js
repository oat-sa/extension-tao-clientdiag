define("taoClientDiagnostic/controller/routes",[],function(){return{CompatibilityChecker:{actions:{index:"controller/compatibilityChecker/index"}}}}),define("taoClientDiagnostic/controller/Authenticator/message",["jquery","lodash","i18n","async","helpers","ui/feedback"],function($,_,__,async,helpers,feedback){"use strict";var init=function(){var $feedbackBox=$("#feedback-box");$feedbackBox.data("error")&&feedback().error($feedbackBox.data("error")),$feedbackBox.data("message")&&feedback().error($feedbackBox.data("message"))};return init()}),define("taoClientDiagnostic/tools/fixedDecimals",[],function(){"use strict";var fixedDecimals=function(value,decimals){var shift=Math.pow(10,Math.abs(decimals||1));
