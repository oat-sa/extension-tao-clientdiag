...
$GLOBALS['__l10n']["%d sources (%s)"]="%d fontes (%s)";
...
$GLOBALS['__l10n']["An error occurred! Please verify your input!"]="Ocorreu um erro! Por favor verifique o input";
...
$GLOBALS['__l10n']["Average bandwidth"]="Largura de banda média";
$GLOBALS['__l10n']["Average intensive bandwidth"]="Largura de banda média intensiva";
$GLOBALS['__l10n']["Average performances"]="Performances médias";
$GLOBALS['__l10n']["Average rendering time"]="Tempo médio de rendering";
...
$GLOBALS['__l10n']["Browser"]="Navegador";
$GLOBALS['__l10n']["Calendar"]="Calendário";
$GLOBALS['__l10n']["Cancel"]="Cancelar";
$GLOBALS['__l10n']["Cannot get your fingerprint"]="Não é possivel obter a identificação";
$GLOBALS['__l10n']["Cannot retrieve the school name. Please verify your input"]="Escola não válida. Por favor verifique os dados inseridos";
$GLOBALS['__l10n']["Change password"]="Mudar palavra-passe";
$GLOBALS['__l10n']["Change since last fingerprint"]="Alterada desde a última identificação";
$GLOBALS['__l10n']["Change the password"]="Mudar a palavra-passe";
$GLOBALS['__l10n']["Check all"]="Marcar todos";
$GLOBALS['__l10n']["Check All"]="Marcar Todos";
$GLOBALS['__l10n']["Checking the bandwidth..."]="A verificar a largura de banda...";
$GLOBALS['__l10n']["Checking the browser..."]="A verificar o navegador...";
$GLOBALS['__l10n']["Checking the media intensive bandwidth..."]="A verificar a largura de banda intensiva... ";
$GLOBALS['__l10n']["Checking the performances..."]="A verificar as performances...";
$GLOBALS['__l10n']["Checking upload speed..."]="A verificar a velocidade de upload";
...
$GLOBALS['__l10n']["Compatible"]="Compatível";
$GLOBALS['__l10n']["Computing the fingerprint..."]="A processar a identificação...";
$GLOBALS['__l10n']["Confirm"]="Confirmar";
$GLOBALS['__l10n']["Connect to the diagnostic tool"]="A ligar à ferramenta de diagnóstico";
...
$GLOBALS['__l10n']["Diagnostic Tool"]="Ferramenta de diagnóstico";
...
$GLOBALS['__l10n']["Dynamic UID"]="UID dinâmico";
...
$GLOBALS['__l10n']["Errors occurred! Please see details"]="Ocurreram erros! Por favor veja os detalhes";
$GLOBALS['__l10n']["Exclusive (OR)"]="Exclusivo (OU)";
$GLOBALS['__l10n']["Exit"]="Sair";
$GLOBALS['__l10n']["Export"]="Exportar";
$GLOBALS['__l10n']["Export "]="Exportar";
$GLOBALS['__l10n']["Extension "]="Extensão";
$GLOBALS['__l10n']["Extensions manager"]="Gestor de extensões";
$GLOBALS['__l10n']["Failed to get school name"]="Não foi possível obter os dados da escola";
...
$GLOBALS['__l10n']["Fingerprint"]="Identificação";
$GLOBALS['__l10n']["Fingerprint error"]="Erro na identificação";
$GLOBALS['__l10n']["Fingerprint errors"]="Erros na identificação";
$GLOBALS['__l10n']["Fingerprint sources"]="Fontes para a identificação";
$GLOBALS['__l10n']["First Name"]="Nome Próprio";
$GLOBALS['__l10n']["First row column names"]="1ª linha Nomes da coluna";
$GLOBALS['__l10n']["Getting school name..."]="A validar os dados de escola...";
$GLOBALS['__l10n']["Go Back"]="Retroceder";
$GLOBALS['__l10n']["Good bandwidth"]="Boa largura de banda";
$GLOBALS['__l10n']["Good performances"]="Boa performance";
$GLOBALS['__l10n']["Good upload speed"]="Boa velocidade de upload";
...
$GLOBALS['__l10n']["Hide Details"]="Esconder os detalhes";
...
$GLOBALS['__l10n']["Intensive bandwidth"]="Largura de banda intensiva";
$GLOBALS['__l10n']["Interface Language"]="Idioma do Interface";
$GLOBALS['__l10n']["Interface language"]="Idioma do interface";
$GLOBALS['__l10n']["Interface not available"]="Interface não disponível";
...
$GLOBALS['__l10n']["Launch another readiness check"]="Lançar outra verificação de prontidão";
$GLOBALS['__l10n']["Launch readiness check"]="Lançar verificação de prontidão";
...
$GLOBALS['__l10n']["List of readiness checks"]="Lista de verificações de prontidão";
$GLOBALS['__l10n']["Loaded"]="Carregado";
$GLOBALS['__l10n']["Loaded at Startup"]="Carregado no inicio";
$GLOBALS['__l10n']["Loading"]="A carregar";
$GLOBALS['__l10n']["Log in"]="Entrar";
$GLOBALS['__l10n']["Log Out"]="Terminar Sessão";
$GLOBALS['__l10n']["Login"]="Entrar";
$GLOBALS['__l10n']["Login available"]="Inicio de sessão disponível";
$GLOBALS['__l10n']["Logout"]="Sair";
$GLOBALS['__l10n']["Low bandwidth"]="Baixa largura de banda";
$GLOBALS['__l10n']["Low upload speed"]="Baixa velocidade de upload";
...
$GLOBALS['__l10n']["Max upload speed"]="Velocidade máxima de upload";
$GLOBALS['__l10n']["Maximum bandwidth"]="Largura de banda máxima";
$GLOBALS['__l10n']["Maximum intensive bandwidth"]="Máxima largura de banda intensiva";
$GLOBALS['__l10n']["Maximum rendering time"]="Tempo máximo de rendering";
$GLOBALS['__l10n']["Media intensive bandwidth"]="Largura de banda intensiva de media";
$GLOBALS['__l10n']["Minimum bandwidth"]="Largura de banda mínima";
$GLOBALS['__l10n']["Minimum intensive bandwidth"]="Largura de banda intensiva miníma";
$GLOBALS['__l10n']["Minimum rendering time"]="Tempo mínimo de rendering";
$GLOBALS['__l10n']["Missing field %s"]="Campo %s não encontrado";
...
$GLOBALS['__l10n']["No diagnostic service defined"]="Serviço de diagnóstico não definido";
...
$GLOBALS['__l10n']["No readiness checks have been done!"]="Não foram realizadas verificações de prontidão ";
...
$GLOBALS['__l10n']["Number of simultaneous test takers the connection can handle"]="Número de ligações simultâneas que a ligação suporta";
$GLOBALS['__l10n']["Number of simultaneous test takers the connection can handle with media intensive"]="Número de ligações simultâneas que a ligação suporta com media intensivo";
$GLOBALS['__l10n']["Old Password"]="Palavra-passe antiga";
$GLOBALS['__l10n']["Operating system"]="Sistema operativo";
$GLOBALS['__l10n']["Operating system and web browser"]="Sistema operativo e navegador de internet (browser)";
...
$GLOBALS['__l10n']["Readiness Check"]="Verificação de prontidão";
$GLOBALS['__l10n']["Readiness checks already done"]="Verificação de prontidão já realizada";
$GLOBALS['__l10n']["Readiness diagnostics"]="Diagnóstico preparados";
$GLOBALS['__l10n']["Record and manage test takers."]="Grava e gere examinados";
$GLOBALS['__l10n']["Refresh"]="Refrescar";
$GLOBALS['__l10n']["Refresh the page"]="Refrescar a página";
$GLOBALS['__l10n']["Remove"]="Eliminar";
$GLOBALS['__l10n']["Remove content"]="Remover conteúdo";
$GLOBALS['__l10n']["Remove the readiness check result?"]="Eliminar o resultado da verificação de prontidão";
$GLOBALS['__l10n']["Remove the selected readiness check results"]="Eminiar o resultado de verificação de prontidão selecionado";
...
$GLOBALS['__l10n']["Return to the list"]="Retornar à lista";
...
$GLOBALS['__l10n']["School name"]="Nome da escola";
$GLOBALS['__l10n']["School name:"]="Nome da escola:";
$GLOBALS['__l10n']["School number"]="Código da escola";
$GLOBALS['__l10n']["School number:"]="Código da escola:";
$GLOBALS['__l10n']["School PIN code (4 digits)"]="Código PIN (4 digitos)";
$GLOBALS['__l10n']["School PIN:"]="Código PIN:";
...
$GLOBALS['__l10n']["Show Details"]="Mostrar os detalhes";
$GLOBALS['__l10n']["Show fingerprint details"]="Mostrar os resultados da identificação";
$GLOBALS['__l10n']["Simple Mode"]="Modo simples";
$GLOBALS['__l10n']["Something went wrong ..."]="Algo correu mal ...";
$GLOBALS['__l10n']["Starting..."]="A iniciar ...";
...
$GLOBALS['__l10n']["The readiness check result have been removed"]="O resultado da verificação de prontidão foi removido";
$GLOBALS['__l10n']["The readiness check result will be removed. Continue ?"]="O resultado da verificação de prontidão vai ser removido. Continuar?";
$GLOBALS['__l10n']["The selected readiness check results will be removed. Continue ?"]="O resultado selecionado da verificação de prontidão vai ser removido. Continuar?";
$GLOBALS['__l10n']["The storage service provided to store the diagnostic results must be upgraded to support reads!"]="O serviço de armazenamento fornecido para guardar os resultados do diagnóstico tem de ser atualizado para suportar leitura!";
...
$GLOBALS['__l10n']["This browser is not tested."]="Este navegador não é testado.";
...
$GLOBALS['__l10n']["This tool will run a number of tests in order to establish how well your current environment is suitable to run the TAO platform."]="Esta ferramenta vai executar um conjunto de testes.";
...
$GLOBALS['__l10n']["Try a test delivery"]="Testar uma entrega de testes";
...
$GLOBALS['__l10n']["Unable to get the workstation name!"]="Não foi possível recolher o nome da máquina!";
...
$GLOBALS['__l10n']["Upload speed"]="Velocidade de upload";
...
$GLOBALS['__l10n']["Very slow performances"]="Performances muito baixas";
$GLOBALS['__l10n']["Web browser"]="Navegador de internet (browser)";
$GLOBALS['__l10n']["Workstation"]="Máquina";
$GLOBALS['__l10n']["Workstation name"]="Nome da máquina";
$GLOBALS['__l10n']["Workstation performances"]="Performance da máquina";
$GLOBALS['__l10n']["Workstation:"]="Máquina:";
$GLOBALS['__l10n']["Yes"]="Sim";
$GLOBALS['__l10n']["Your fingerprint is %s"]="A identificação desta máquina é %s";
$GLOBALS['__l10n']["Your fingerprint is %s. However it seems it has changed since the last check. It could be related to changes in your system."]="A identificação desta máquina é %s. Contudo foi alterada desde a última verificação. Pode estar relacionado como mudanças no sistema.";
$GLOBALS['__l10n']["Your fingerprint is %s. However we encountered issue while retrieving the data. Maybe your available disk space is too small"]="A identificação desta máquina é %s. Contudo foi encontrado um problema ao recolher os dados. O espaço em disco pode ser muito pequeno";
$GLOBALS['__l10n']["Your system is fully compliant."]="O seu sistema é totalmente compatível.";
$GLOBALS['__l10n']["Your system is not optimal, please contact your system administrator."]="O seu sistema não é óptimo.";
$GLOBALS['__l10n']["Your system requires a compatibility update, please contact your system administrator."]="O seu sistema necessita de updates para compatibilidade.";
